...
public abstract  class BlunoLibrary  extends Activity{
    ...
    public void onCreateProcess()
    {
    	if(!initiate())
		{
			Toast.makeText(mainContext, com.dji.sdk.sample.R.string.error_bluetooth_not_supported,
...
//                    updateConnectionState(R.string.comm_establish);
	...
	private class LeDeviceListAdapter extends BaseAdapter {
		...
		public View getView(int i, View view, ViewGroup viewGroup) {
			...
			if (view == null) {
				view = mInflator.inflate(com.dji.sdk.sample.R.layout.listitem_device, null);
				viewHolder = new ViewHolder();
				viewHolder.deviceAddress = (TextView) view
						.findViewById(com.dji.sdk.sample.R.id.device_address);
				viewHolder.deviceName = (TextView) view
						.findViewById(com.dji.sdk.sample.R.id.device_name);
			...
			if (deviceName != null && deviceName.length() > 0)
				...
				viewHolder.deviceName.setText(com.dji.sdk.sample.R.string.unknown_device);
